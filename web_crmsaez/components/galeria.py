...
def galeria() -> rx.Component:
    return rx.box(
        rx.center(
        rx.responsive_grid(    
    rx.image(src="/imagen1.png", alt="imagen1", height="20em", width="30em"),
    rx.image(src="/imagen2.png", alt="imagen2", height="20em", width="30em"),
    ...
    rx.image(src="/mampara1.jpg", alt="imagen11", height="20em", width="30em"),
    rx.image(src="/oficina.jpg", alt="imagen12", height="20em", width="30em"),
    columns=[3],
    spacing="auto",
